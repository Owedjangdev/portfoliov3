export const faqStyles = {
  ...
  container: 'max-w-3xl mx-auto px-6', // On réduit la largeur pour une meilleure lecture
  ...
  item: 'group border border-gray-100 dark:border-white/5 rounded-2xl bg-gray-50/50 dark:bg-white/5 overflow-hidden transition-all duration-300',
  ...
  answerWrapper: 'grid transition-all duration-300 ease-in-out', // Pour l'animation de hauteur
